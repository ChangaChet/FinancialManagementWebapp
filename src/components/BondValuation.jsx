         ...
         sections: [
            {
                ...
                content: (
                    <>
                        ...
                        <InfoBlock><p>A common approximation is <code className="bg-gray-200 p-1 rounded">R ≈ r + h</code>. This works well when inflation is low.</p></InfoBlock>
                    </>
                )
            }
        ]
            ...
            <InteractivePlayground title="Bond Type Calculators">
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow space-y-3">
                         ...
                         <div><label>Par Value: <span className="font-bold">${fcPar}</span></label><input type="range" min="100" max="2000" step="100" value={fcPar} onChange={e => setFcPar(Number(e.target.value))} className="interactive-slider" /></div>
                         <div><label>Coupon Rate: <span className="font-bold">{fcCouponRate}%</span></label><input type="range" min="1" max="15" step="0.5" value={fcCouponRate} onChange={e => setFcCouponRate(Number(e.target.value))} className="interactive-slider" /></div>
                         <div><label>Market Rate: <span className="font-bold">{fcMarketRate}%</span></label><input type="range" min="1" max="15" step="0.5" value={fcMarketRate} onChange={e => setFcMarketRate(Number(e.target.value))} className="interactive-slider" /></div>
                         <div><label>Years: <span className="font-bold">{fcYears}</span></label><input type="range" min="1" max="30" value={fcYears} onChange={e => setFcYears(Number(e.target.value))} className="interactive-slider" /></div>
                     ...
                     <div className="bg-white p-6 rounded-lg shadow space-y-3">
                         ...
                         <div><label>Face Value: <span className="font-bold">${zcPar}</span></label><input type="range" min="1000" max="5000" step="500" value={zcPar} onChange={e => setZcPar(Number(e.target.value))} className="interactive-slider" /></div>
                         <div><label>Market Rate: <span className="font-bold">{zcMarketRate}%</span></label><input type="range" min="1" max="15" step="0.5" value={zcMarketRate} onChange={e => setZcMarketRate(Number(e.target.value))} className="interactive-slider" /></div>
                         <div><label>Years: <span className="font-bold">{zcYears}</span></label><input type="range" min="1" max="30" value={zcYears} onChange={e => setZcYears(Number(e.target.value))} className="interactive-slider" /></div>
                     ...
                     <div className="bg-white p-6 rounded-lg shadow space-y-3">
                         ...
                         <div><label>Annual Coupon: <span className="font-bold">${pCoupon}</span></label><input type="range" min="10" max="200" step="10" value={pCoupon} onChange={e => setPCoupon(Number(e.target.value))} className="interactive-slider" /></div>
                         <div><label>Market Rate: <span className="font-bold">{pMarketRate}%</span></label><input type="range" min="1" max="15" step="0.5" value={pMarketRate} onChange={e => setPMarketRate(Number(e.target.value))} className="interactive-slider" /></div>
            ...
            <InteractivePlayground title="Ratings and Yield Spreads">
                 ...
                 <div className="grid md:grid-cols-2 gap-8 items-center">
                    <div className="space-y-4">
                        ...
                        <input type="range" min="1" max="10" step="1" value={rating} onChange={e => setRating(Number(e.target.value))} className="interactive-slider" />
                    </div>
            ...
            <InteractivePlayground title="Fisher Effect Calculator">
                 <div className="grid md:grid-cols-3 gap-8 items-center">
                     <div className="space-y-2">
                         ...
                         <input type="range" min="0" max="10" step="0.5" value={realRate} onChange={e => setRealRate(Number(e.target.value))} className="interactive-slider" />
                     </div>
                      <div className="space-y-2">
                         <label>Inflation (h): <span className="font-bold text-blue-600">{inflation}%</span></label>
                         <input type="range" min="0" max="10" step="0.5" value={inflation} onChange={e => setInflation(Number(e.target.value))} className="interactive-slider" />
                     </div>
                     <div className="bg-white p-6 rounded-lg shadow-md text-center">
